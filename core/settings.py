...
if not PHARMACY_REGISTRATION_KEY:
    # Fallback for dev if .env is missing, but in production this should be set as env var
    PHARMACY_REGISTRATION_KEY = "DEV-SECRET-KEY"
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'queue_manager' / 'templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
